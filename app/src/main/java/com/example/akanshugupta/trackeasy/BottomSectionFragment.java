...
public class BottomSectionFragment extends Fragment {
    ...
    private Button mMap;
    private static TextView X_init;
    private static TextView Y_init;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        X_init=(TextView)view.findViewById(R.id.x_initial);
        Y_init=(TextView)view.findViewById(R.id.y_initial);
        ...
        mMakeX_init(activityCommander.initX(),activityCommander.initY());
